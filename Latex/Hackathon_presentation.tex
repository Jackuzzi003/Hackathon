...
\medskip
\only<1>{ \begin{center} \Huge Robot \end{center}}
\only<2>{\begin{flushleft} \Huge Robot \end{flushleft} }
\only<3-4>{\begin{flushright} \Huge Robot \end{flushright} }
\end{frame}
...
\begin{flushleft}
\only<1-2,6>{\Huge Robot}
\only<3>{\hspace{2.3cm}\Huge Robot}
\only<4>{\hspace{4.6cm}\Huge Robot}
\only<5,7>{\hspace{6.9cm}\Huge Robot}
\end{flushleft}
